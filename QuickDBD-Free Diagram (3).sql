...
-- Link to schema: https://app.quickdatabasediagrams.com/#/d/jC08aM
...
ALTER TABLE `custumors` ADD CONSTRAINT `fk_custumors_cust_id` FOREIGN KEY(`cust_id`)
